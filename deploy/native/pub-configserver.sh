...
pscp -h hosts/configserver  -l  root  ../../lib/omega-framework-configserver*.jar /opt/omega-framework/lib/

pssh -h hosts/configserver -l root -i ' curl -fsSL -X POST http://localhost:8080/shutdown ;  \
